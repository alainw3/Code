...
class GPTModel(nn.Module):
    def __init__(self, cfg):
        ...
        #use a placdholder for LayerNorm
...
def generate_text_simple (model, idx, max_new_tokens, context_size):
    ...
    for _ in range(max_new_tokens):
        ...
        # Focus ony on the last time step
        # (bactch, n_tokens, vocab_size) becomes (batch, vocab_size)
        logits =logits [:,-1,:]
        ...
        idx = torch.cat((idx,idx_next), dim=1) # (barch, n_tokens+1)
